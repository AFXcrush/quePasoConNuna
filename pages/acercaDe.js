        ...
        <section className={styles.acercaDe}>
          <div className={styles.acercaDeText}>
            <div className={styles.acercaDeTextContainer}>
              <h1>Acerca de</h1>
              <p>
                '¿Qué pasó con Nuna?' es un mini documental transmedia que
                recopila información inédita sobre los inicios, la producción y
                el estancamiento de la película peruana animada 'Nuna: La agonía
